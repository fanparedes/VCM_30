              ...
              <?php echo $this->Form->create('Area', array('id' => 'form_actividad', 'class' => 'form-horizontal')); ?>
                <div id="tab-general">
                        <div class="row mbl">
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="generalTabContent" class="tab-content">
                                    <div id="tab-edit" class="tab-pane fade in active">  
                                      <h3>Exitar Area</h3>
                                      <a href="<?php echo $abs_base.'areas/index'; ?>" class="btn btn-red pull-right"  style="margin-top:-47px;">Cancelar</a>
                                          ...
                                          <div class="col-sm-12">
                                            <label class="col-sm-3 control-label">Nombre</label> 
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                        <input id="nombre" maxlength="50" name="data[Area][area]" type="text" placeholder="" class="form-control" value="<?php echo $this->data['Area']['area']; ?>"/>
                                                        <input maxlength="50" name="data[Area][id]" type="hidden" placeholder="" class="form-control" value="<?php echo $this->data['Area']['id']; ?>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                          </div>           
