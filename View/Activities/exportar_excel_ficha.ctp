			...
			<?php
				echo '<tr>';
					...
					if ($activity['Activity']['financiamiento_i_e_m'] == 1) {
		 				...
		 				echo '<b>'.utf8_decode('Entidades Académicas').': </b>'.$activity['Activity']['entidadesacademicas'].'% - ';
...
<body>
	<table border="1">
		<thead>
			...
			<th><?php echo  mb_convert_encoding('Breve descripción de la Actividad','UTF-8', 'ISO-8859-1'); ?></th>
			...
			<th><?php echo  mb_convert_encoding('Áreas centrales a las que pertenece','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Nombre del proyecto en el qué se enmarca','UTF-8', 'ISO-8859-1'); ?></th>
			...
			<th><?php echo  mb_convert_encoding('Breve descripción del convenio','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Objetivo General de la actividad','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Objetivos específicos','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Principios de la política que aborda','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Justificación de principios abordados','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Público abordado Interno','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Número de participantes aprox.','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Público abordado Externo','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Número de participantes aprox.','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Beneficiados de la implementación del proyecto','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Ámbitos de acción en los que se enmarca la actividad','UTF-8', 'ISO-8859-1'); ?></th>
			<th><?php echo  mb_convert_encoding('Asocie el área a la que más se asimile su actividad (elija una)','UTF-8', 'ISO-8859-1'); ?></th>
