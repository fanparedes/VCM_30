                                ...
                                <div id="grid-layout-table-1" class="box jplist">
                                    ...
                                    <!-- boton buscar -->
                                     <div class="col-lg-2">
                                        <div class="form-group">
                                            <button type="button" id="btnBuscar" class="btn btn-primary" onclick="paginate(1);">
                                            Buscar</button>
                                        </div>
                                    </div>
                                    <!-- filtros select -->
                                      <div class="text-filter-box" >
                                        ...
                                        <input name="data[Activity][nombre]" id="nombre" type="text" value="" placeholder="Filtro por Nombre" class="form-control" style="width:250px;"/>
                                                        ...
                                                        <div class="col-lg-2">
                                                          <input type="reset" name="btReset" id="btReset" value="Limpiar" class="btn">
                                                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <button type="button" class="btn btn-blue" data-toggle="modal" data-target="#myModal">
                                              <i class="fa fa-download"></i>&nbsp;Descargar fichas en PDF
                                            </button>
                                              <?php
                                        ...
                                        <!--<item>1</item>-->
                                            <tr class="tbl-item"><!--<img/>-->
                                               <td class="img"> <a href="<?php echo $abs_base.'activities/ficha/'.$act_sin_ev['Activity']['id'];?>">
													...
													<?php
                          $nombre_imagen  = (string) isset($act_sin_ev['Activity']['Image']['Image']['nombre']) ? $act_sin_ev['Activity']['Image']['Image']['nombre'] : '';
                                                        if (isset($act_sin_ev['Activity']['Image']['Image']['nombre']) && file_exists(WWW_ROOT.'uploads'.DS.$nombre_imagen)) { ?>
  ...
  function paginate(page) {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            var _registros_totales = $("#_registros_totales").val();
            if(parseInt(_registros_totales)>50){
              var cant_pdf = Math.ceil((_registros_totales/50));
              //console.log(cant_pdf+' - '+_registros_totales);
            }else{
              var cant_pdf = 1;
            }
            ...
            for(var i=1; i<=cant_pdf; i++){
                var dife = _registros_totales-end;
                star = (1+end);
                end  = 50+end;
                if(dife<=50 && i!=cant_pdf){
                  if(i>1){
                    end = 50+dife;
                  }else{
                    end = dife;
                ...
                $(".modal-body").append('<a href="/actividades_vcm/home/activities/exportar_pdf/'+star+'/'+end+'" class="btn btn-blue">'+star+' - '+end+'</a>&nbsp;');
            }
            /*
             $cant_pdf = round(($cant_rs/50));
            //echo $cant_pdf;
            $star = 0;
            $end  = 0;
            for($i=1; $i<=$cant_pdf; $i++){
                $dife = $cant_rs-$end;
                $star = (1+$end);
                $end  = 50+$end;
                if($dife<=50){
                ...
                echo "&nbsp;".$this->Html->link('fichas desde '.$star.' hasta '.($end), array(
                    'controller' => 'activities',
                    'action' => 'exportar_pdf/'.$star.'/'.$end),
                    array(
                      'class' => 'btn btn-blue',
                      'escape' => false
                      )
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Descargar Actividades</h4>
      </div>
      <div class="modal-body">
       <?php
          $cant_pdf = round(($cant_rs/50));
          ...
          for($i=1; $i<=$cant_pdf; $i++){
              ...
              echo "&nbsp;".$this->Html->link($star.' - '.($end), array(
                  'controller' => 'activities',
                  'action' => 'exportar_pdf/'.$star.'/'.$end),
                  array(
                    'class' => 'btn btn-blue',
