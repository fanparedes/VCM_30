                                          ...
                                          <div class="col-sm-12">
                                            <label class="col-sm-3 control-label">Nombre</label> 
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                        <input id="nombre" maxlength="50" name="data[Scope][ambito]" type="text" placeholder="" class="form-control" value="<?php echo $this->data['Scope']['ambito']; ?>"/>
                                                        <input maxlength="50" name="data[Scope][id]" type="hidden" placeholder="" class="form-control" value="<?php echo $this->data['Scope']['id']; ?>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                          </div>           
