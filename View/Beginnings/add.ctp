                                          ...
                                          <div class="col-sm-12">
                                            <label class="col-sm-3 control-label">Nombre</label> 
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                        <input id="nombre" maxlength="50" name="data[Beginning][principio]" type="text" placeholder="" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                          </div>           
                                          ...
                                          <div class="col-sm-12">
                                            <label class="col-sm-3 control-label">Descripción</label> 
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                        <textarea id="descripcion" maxlength="200" name="data[Beginning][descripcion]" placeholder="" class="form-control" /></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                          </div>           
